...
import calendario2 from '../../src/documentos/calendario-academico-2023-2.pdf';
import calendario2024_1 from '../../src/documentos/Calendario-academico-2024-1.pdf';
...
const Documentos = () => {
    return(
      ...
      <Accordion.Item eventKey="3">
        <Accordion.Header><i className="bi bi-cloud-download-fill icon-help"></i>Calendario Académico</Accordion.Header>
        <Accordion.Body>
        <a href={calendario2024_1} target="_blank" >
          <i className="bi bi-file-earmark-arrow-down icon-download"></i>Calendario Académico 2024-1
        </a>
        <a href={calendario2} target="_blank" >
