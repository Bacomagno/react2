      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-2 col-md-3 footer-links">
            <h4>Inicio</h4>
            <ul>
              <li><Link to='/Bienestar' onClick={ScrollToTop}>Bienestar</Link></li>
              <li><Link to="/noticias" onClick={ScrollToTop}>Noticias y Eventos</Link></li>
              <li><Link to="/Proceso_de_inscripcion" onClick={ScrollToTop}>Proceso de inscripción</Link></li>
              <li><Link to='/Financiamiento' onClick={ScrollToTop}>Financiamiento</Link></li>
          ...
          <div className="col-lg-2 col-md-3 footer-links">
            ...
            <ul>
              ...
              <li><Link to="/Contactenos" onClick={ScrollToTop}><span>Contactenos</span></Link></li>
            </ul>
          </div>
